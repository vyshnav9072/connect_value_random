...
class addworkreport extends StatefulWidget {
  const addworkreport({super.key});

  @override
  State<addworkreport> createState() => _addworkreportState();
}

class _addworkreportState extends State<addworkreport> {
  ...
  Future createworkreport() async {
    ...
    print(reqData);
    var response = await WorkreportService.CreateWorkReport(reqData);
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("Add Work Report", style: TextStyle(color: bg)),
        centerTitle: true,
